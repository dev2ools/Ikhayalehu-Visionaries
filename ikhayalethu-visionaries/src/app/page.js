...
export default function Home() {
  return (
    <div className="relative min-h-screen">
      ...
      {/* Overlay */}
      <div className="absolute inset-0 bg-black bg-opacity-50 z-10" style={{ backgroundImage: "url('https://i.postimg.cc/W1tF9j23/Whats-App-Image-2025-04-03-at-21-16-19-f20db238.jpg')" }}></div>
